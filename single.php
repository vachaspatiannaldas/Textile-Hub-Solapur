					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#review" data-toggle="tab">Reviews (5)</a></li>
							</ul>
						</div>
							...
							<div class="tab-pane fade active in" id="review" >
								...
								<div class="col-sm-12">
									...
									<form action="" method="POST">
										...
										<a href="single.php?pid=<?php echo $i;?>" >
										
										     <input type="submit" name="b1" value="Submit" class="btn btn-default pull-right">
										 </a>	
								...
								<div class="item active">	
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/mayurpankhi2.jpg" alt="" height="220"/>
													<p>Mayurpankhi</p>
											...
											<div class="overlay-content">
												<h2><img src="images/AJ/rs.png" alt="" height="20"/>400</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/Handloom1.jpg" alt="" height="220" />
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/mayur4.jpg" alt="" height="220"/>
													...
													<div class="product-overlay">
											<div class="overlay-content">
												<h2><img src="images/AJ/rs.png" alt="" height="20"/>650</h2>
												<a href="single.php?pid=<?php echo $r[0];?>"><p>Mayur</p></a>
												<a href="usercart.php?pid=<?php echo $r[0];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								...
								<div class="item">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/mayurpankhi4.jpg" alt="" height="220"/>
													...
													<div class="product-overlay">
											<div class="overlay-content">
												<h2><img src="images/AJ/rs.png" alt="" height="20"/>600</h2>
												<a href="single.php?pid=<?php echo $r[0];?>"><p>Mayurpankhi</p></a>
												<a href="usercart.php?pid=<?php echo $r[0];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/Solid2.jpg" alt="" height="220"/>
													...
													<div class="product-overlay">
											<div class="overlay-content">
												<h2><img src="images/AJ/rs.png" alt="" height="20"/>60</h2>
												<a href="single.php?pid=<?php echo $r[0];?>"><p>Solid</p></a>
												<a href="usercart.php?pid=<?php echo $r[0];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/Stripe3.jpg" alt="" height="220"/>
													...
													<div class="product-overlay">
											<div class="overlay-content">
												<h2><img src="images/AJ/rs.png" alt="" height="20"/>175</h2>
												<a href="single.php?pid=<?php echo $r[0];?>"><p>Stripe</p></a>
												<a href="usercart.php?pid=<?php echo $r[0];?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
